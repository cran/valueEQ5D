...
test_that("test for value3L", {
  ...
  expect_error(value3LInd("UK","TTO",c(1,1,1)),"Invalid EQ-5D-5L responses-check the responses to each question",fixed=TRUE)
  ...
  expect_error(value3LInd("UK","TTO",c(1,1,1)),"Invalid EQ-5D-5L responses-check the responses to each question",fixed=TRUE)
  expect_error(value3LInd("UK","TTO",c(3,4,5,6,7,8)),"Invalid EQ-5D-5L responses-check the responses to each question",fixed=TRUE)
...
test_that("test for value3L", {
  ...
  expect_error(value3LInd("UK","VAS",c(1,1,1), NA, NA, NA, NA),"Invalid EQ-5D-5L responses-check the responses to each question",fixed=TRUE)
  ...
  expect_error(value3LInd("UK","VAS",c(1,1,1)),"Invalid EQ-5D-5L responses-check the responses to each question",fixed=TRUE)
  expect_error(value3LInd("UK","VAS",c(3,4,5,6,7,8)),"Invalid EQ-5D-5L responses-check the responses to each question",fixed=TRUE)
