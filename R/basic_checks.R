...
#' @examples
#' testFileExistRead(system.file("extdata", "blank.txt", package = "valueEQ5D"))
#' @export
...
#' @examples
#' checkColumnExist("age", data.frame(age = rep(20, 4), sex = rep("male", 4), 
...
#' @examples
#' getColumnNoColNames(data.frame(age = rep(20, 4), sex = rep("male", 4)), "sex")
#' @export
...
#' @examples
#' getFrequencyTable(c(1, 1, 1, 12, 2))
#' @export
...
#' @return digits
#' @examples
#' convertNumberToIndividualDigits(234)
#' @export
...
#' @examples
#' getColNumExistingColNames(c("age"), data.frame(age = rep(20, 4), gender = rep("male", 4)))
#' @export
...
#' @return the column number
#' @examples
#' subsetGenderAgeToGroup(data.frame(age = rep(20, 4), gender = rep("male", 4)), "male", c(10, 70))
#' @export
...
#' @examples
#' replaceSpaceUnderscore("Sri Lanka")
#' @export
